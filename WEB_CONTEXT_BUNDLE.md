...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.74-kirby-problem-3.74-4892ff76-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.74"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.74-kirby-problem-3.74-4892ff76-v1",
      "problem_contract_sha256": "c0283a00c17c3cd586e76257dad399b535ba4d606c3bc1fb5a86f01d80f546da",
      "problem_id": "problem:um-kp-3.74-kirby-problem-3.74-4892ff76",
      "route_id": "route:um-kp-3.74-kirby-problem-3.74-4892ff76-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.74-kirby-problem-3.74-4892ff76-source-fidelity-01",
      "graph_id": "graph:um-kp-3.74-kirby-problem-3.74-4892ff76-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.74-kirby-problem-3.74-4892ff76-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.74-kirby-problem-3.74-4892ff76-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $Y$ be a rational homology sphere and $f:Y\\to Y$ be a self-diffeomorphism of $Y$. Suppose $W$ is a 4-manifold with boundary $Y$ such that $f$ extends to a self-diffeomorphism of $W$. (a) What constraints are there on the intersection form of $W$? (b) Does there exist a pair $(Y,f)$ such that $Y$ bounds a homology ball but $f:Y\\to Y$ does not extend over any definite manifold of either sign? (c) Develop methods for constraining the intersection form of $W$ that apply to indefinite, non-spin $W$."
          },
          "statement_sha256": "a4b8d1bf81a306ecd7048ed2497c2a3e3addb4f3b22dc1d689f0cc40eef37967"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.74-kirby-problem-3.74-4892ff76-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.74-kirby-problem-3.74-4892ff76-root",
      "route_id": "route:um-kp-3.74-kirby-problem-3.74-4892ff76-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.74-3cf18d3defcd",
        "url": "https://www.unsolvedmath.com/problems/KP-3.74"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
